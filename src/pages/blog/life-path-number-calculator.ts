export const slug = 'life-path-number-calculator'
export const title = 'Life Path Number Calculator: Find Your Numerology Life Path from Date of Birth'
export const metaDescription = 'Calculate your Life Path Number using our free numerology calculator. Learn what your life path number reveals about your personality, career, and destiny. By Ashima Gautam, Vancouver numerologist.'
export const keywords = 'life path number calculator, numerology calculator, life path number meaning, numerology by date of birth, destiny number calculator'
...
export const content = [
  ...
  { type: 'ol', items: [
    'Break down your birth date into month, day, and year: 10 (October) + 25 (day) + 1990 (year)',
    'Reduce each component to a single digit: 10 → 1+0 = 1, 25 → 2+5 = 7, 1990 → 1+9+9+0 = 19 → 1+9 = 10 → 1+0 = 1',
    'Add the three reduced numbers: 1 + 7 + 1 = 9',
  ...
  { type: 'ul', items: [
    'Master Number 11: The Intuitive — heightened spiritual insight and inspiration',
    'Master Number 22: The Master Builder — ability to turn dreams into reality on a large scale',
    'Master Number 33: The Master Teacher — spiritual leadership and healing abilities'
  ]},
  ...
  { type: 'p', text: 'Challenges: Avoid being overly controlling, stubborn, or dismissive of others\' input. Learn to collaborate while maintaining your independence.' },
  ...
  { type: 'p', text: 'Challenges: Avoid being overly sensitive, passive, or dependent on others\' approval. Develop self-confidence while maintaining your diplomatic nature.' },
  ...
  { type: 'p', text: 'Challenges: Avoid scattering your energy across too many projects, superficiality, or using humor to avoid deeper issues. Focus your creative talents for meaningful impact.' },
  ...
  { type: 'p', text: 'Challenges: Avoid rigidity, workaholism, or resistance to change. Balance your need for structure with flexibility and spontaneity.' },
  ...
  { type: 'p', text: 'Challenges: Avoid restlessness, impulsiveness, or commitment-phobia. Channel your adventurous spirit into meaningful experiences rather than escapism.' },
  ...
  { type: 'p', text: 'Challenges: Avoid over-giving, martyrdom, or neglecting your own needs. Set healthy boundaries while maintaining your nurturing nature.' },
  ...
  { type: 'p', text: 'Challenges: Avoid isolation, over-thinking, or cynicism. Balance introspection with connection and practical application.' },
  ...
  { type: 'p', text: 'Challenges: Avoid workaholism, materialism, or using power unethically. Balance ambition with integrity and personal relationships.' },
  ...
  { type: 'p', text: 'Challenges: Avoid self-sacrifice, bitterness, or inability to let go. Practice self-care while maintaining your compassionate nature.' },
  ...
  { type: 'h3', text: 'Life Purpose and Direction' },
  { type: 'p', text: 'Understanding your Life Path Number helps you make decisions aligned with your true purpose. When facing major life choices, consider whether the path honors your Life Path Number\'s core themes.' },
  
  { type: 'h2', text: 'Beyond Life Path: Your Complete Numerology Profile' },
  { type: 'p', text: 'While Life Path Number is the most important, your complete numerology profile includes several other key numbers:' },
  { type: 'ul', items: [
    'Destiny Number (from your full name): What you\'re meant to achieve and contribute',
    'Soul Urge Number (from vowels in your name): Your inner desires and motivations',
    'Personality Number (from consonants in your name): How others perceive you',
    'Birth Day Number (from your birth day): Specific talents and challenges'
  ]},
  
  { type: 'h2', text: 'Book Your Complete Numerology Reading with Ashima Gautam' },
  { type: 'p', text: 'For a thorough numerology analysis that goes beyond just your Life Path Number, book a personalized reading with Ashima Gautam at Ashima Empowers. Ashima blends Numerology with Vedic Astrology and Palmistry for multi-layered insights that are sharper than any single discipline alone.' },
